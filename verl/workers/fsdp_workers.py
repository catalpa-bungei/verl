...
class ActorRolloutRefWorker(Worker):
    ...
    def __init__(self, config: DictConfig, role: str):
        ...
        # normalize config
        if self._is_actor:
            print(f"-----------------------------------------------\nconfig.rollout.n: {self.config.rollout.n}, config.actor.ppo_mini_batch_size: {self.config.actor.ppo_mini_batch_size}, device_mesh.size(): {self.device_mesh.size()}, ulysses_sequence_parallel_size: {self.ulysses_sequence_parallel_size}")
