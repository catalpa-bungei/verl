...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/mnt/shared-storage-user/yangxuqing/verl/merged_model/qwen2_5_vl_7b_promptv8_T5_temp0.7-text-beta0.1_alpha0.5/global_step_103 \
    ...
    trainer.project_name='verl_grpo_textR2-test0.01_qwen2.5vl-7b_promptv8_T5_temp0.7' \
    trainer.experiment_name='text-beta0.1_alpha0.5' \
