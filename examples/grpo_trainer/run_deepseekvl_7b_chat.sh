...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/fs-computility/ai-shen/shared/hf-hub/models--OpenGVLab--InternVL3-8B-Instruct/snapshots/6f7ca0c728c9be6e83def940ebc046a60ebeb9c0 \
    ...
    trainer.project_name='verl_grpo_text-test0.01_deepseekvl-7b-chat_promptv8_T5_temp0.7' \
