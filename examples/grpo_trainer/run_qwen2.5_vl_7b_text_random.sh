...
random_train_path=/fs-computility/wangxuhong/yangxuqing/post_processing/create_training_data/data/text/random/text_random_train_promptv8.parquet
random_test_path=/fs-computility/wangxuhong/yangxuqing/post_processing/create_training_data/data/text/random/text_random_test_promptv8.parquet


train_files="['$random_train_path']"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='verl_grpo_textRandom-test0.01_qwen2.5vl-7b_promptv8_T5_temp0.7' \
    trainer.experiment_name='textRandom-beta0.1_alpha0.5' \
