...
<<<<<<< HEAD
    actor_rollout_ref.model.path=/fs-computility/ai-shen/shared/hf-hub/models--meta-llama--Llama-3.2-3B-Instruct \
=======
    actor_rollout_ref.model.path=/mnt/shared-storage-user/yangxuqing/models/models--meta-llama--Llama-3.2-3B-Instruct \
>>>>>>> a3ea79f409eddf1a8409819ec368de5c3de333ff
...
<<<<<<< HEAD
    trainer.experiment_name='text-beta0.1_alpha0' \
