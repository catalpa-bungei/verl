...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/fs-computility/wangxuhong/yangxuqing/models/InternVL \
    ...
    trainer.project_name='verl_grpo_text-test0.01_internvl3-8b-Instruct_promptv8_T5_temp0.7' \
