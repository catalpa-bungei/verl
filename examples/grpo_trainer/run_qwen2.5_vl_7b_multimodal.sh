...
test_path=/fs-computility/wangxuhong/yangxuqing/post_processing/create_training_data/data/multimodal/multimodal_test_promptv8.parquet
m3cot_train_path=/fs-computility/wangxuhong/yangxuqing/post_processing/create_training_data/data/M3CoT/multimodal_train_promptv8.parquet
m3cot_test_path=/fs-computility/wangxuhong/yangxuqing/post_processing/create_training_data/data/M3CoT/multimodal_test_promptv8.parquet
train_files="['$m3cot_train_path']"
test_files="['$m3cot_test_path']"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='verl_grpo_m3cot-test0.01_qwen2.5vl-7b_promptv8_T5_temp0.7' \
    trainer.experiment_name='m3cot-beta0.4_alpha0' \
